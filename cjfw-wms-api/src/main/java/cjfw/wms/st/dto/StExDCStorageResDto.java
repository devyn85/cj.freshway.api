 ...
 */
@Data
@Schema(description = "외부창고정산 조회 결과")
public class StExDCStorageResDto extends CommonProcedureDto {
	/** 커스텀 엑스트라 체크박스 */
    ...
    /** 공급가차액 */
    @Schema(description = "공급가차액", nullable = true, example = "")
    private Double supplyPriceDiff;
    ...
    /** 위탁물류상품 여부 */
    @Schema(description = "위탁물류상품 여부", nullable = true, example = "")
    private String tplYn;
    
    /** PROCESSFLAG */
    @Schema(description = "PROCESSFLAG", nullable = true, example = "")
    private String processflag;

    /** PROCESSMSG */
    @Schema(description = "PROCESSMSG", nullable = true, example = "")
