...
public class Scm0060Batch {

	private static final String BATCH_JOB_NAME = "scm0060Job";
	private final CommonDao commonDao;

	private final Scm0060BatchService scm0060BatchService;
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				scm0060BatchService.callScm0060JobService(batchParam, batchLogDto); 
