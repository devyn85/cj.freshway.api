 ...
 * @date : 2025.07.16 
 * @description : 출고재고보충(수원3층) 요청 DTO
 * @issues :<pre> 
 * ----------------------------------------------------------- 
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "출고재고보충(수원3층) 요청") 
public class StLocMoveRPReqDto extends CommonProcedureDto {
	
	/** 저장 리스트 */
	List<StLocMoveRPResSaveDto> saveCreationList;
	/** 저장 리스트 */
	List<StLocMoveRPResTab1Dto> saveList;
	/** 저장 리스트 */
	List<StLocMoveRPResTab1Dto> saveDataList;
