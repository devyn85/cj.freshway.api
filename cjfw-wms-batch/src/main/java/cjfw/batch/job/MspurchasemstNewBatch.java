...
public class MspurchasemstNewBatch {

    private static final String BATCH_JOB_NAME = "mspurchasemstNewJob";
	...
	@Bean
	public Job mspurchasemstNewJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("mspurchasemstNewService.callProcExecute", batchParam);
			} catch (Exception e) {
