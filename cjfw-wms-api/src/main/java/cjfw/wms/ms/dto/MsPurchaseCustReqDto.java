 ...
 */
@Data
@Schema(description = "수발주기초정보 조회 조건 DTO")
public class MsPurchaseCustReqDto extends CommonProcedureDto {
    ...
    @Schema(description = "수급대상 여부")
    private String purchaseYn;
    
    @Schema(description = "조회조건 체크")
    private String chkPurchasemst;
