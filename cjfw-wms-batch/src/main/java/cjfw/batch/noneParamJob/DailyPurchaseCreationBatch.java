...
public class DailyPurchaseCreationBatch {

	private static final String BATCH_JOB_NAME = "dailyPurchaseCreationJob";
	...
	@Bean
	public Job dailyPurchaseCreationJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailyPurchaseCreationJobs", batchParam);
			} catch (Exception e) {
