...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "운송비정산 요청") 
public class TmTrxCalculationReqDto extends CommonProcedureDto {	
    ...
    /** 마감/취소 */
    @Schema(description = "마감/취소", nullable = true, example = "")
