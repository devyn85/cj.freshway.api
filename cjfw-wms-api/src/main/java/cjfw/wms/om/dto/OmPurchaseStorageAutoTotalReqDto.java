 ...
 * @date        : 2025.10.14
 * @description : 저장품자동발주 기능을 구현한 Req DTO Class
 * @issues      :
 * -----------------------------------------------------------
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "저장품자동발주 요청") 
public class OmPurchaseStorageAutoTotalReqDto extends CommonProcedureDto {
	/** 메인그리드 저장 리스트 */
	List<OmPurchaseStorageAutoTotalReqDto> saveList;
	
	/** 메인그리드 저장 리스트 */
    List<OmPurchaseStorageAutoTotalResDto> saveOutSTOList;
    ...
    @Schema(description = "비계약 재고 수량 (Display 제외)")
    ...
    @Schema(description = "외부")
    private String stoout;
    
    @Schema(description = "직송 여부")
    private String dlvYn;
    
    @Schema(description = "상태")
    private String status;
    
    @Schema(description = "수급 이미지 호출 로그 ID")
    private String logId;
    
    @Schema(description = "수급 이미지 호출 로그 키")
    ...
    @Schema(description = "멀티 창고 코드")
    private String multiOrganizeCode;
    
    @Schema(description = "재고번호")
    private String stockid;
    
    /** 저장 리스트 - 실적 미수신 */ 
    List<OmPurchaseStorageAutoTotalResDto> receiversList;
    List<OmPurchaseStorageAutoTotalResDto> detailList;
