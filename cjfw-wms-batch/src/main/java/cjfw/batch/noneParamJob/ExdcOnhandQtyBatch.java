...
public class ExdcOnhandQtyBatch {
    
    private static final String BATCH_JOB_NAME = "exdcOnhandQtyJob"; 
    ...
    public Tasklet execTasklet() {
        return (contribution, chunkContext) -> {
            ...
            try {
                ...
                commonDao.selectOne("exdcOnhandQtyService.saveStExdcApiStock", paramMap);
