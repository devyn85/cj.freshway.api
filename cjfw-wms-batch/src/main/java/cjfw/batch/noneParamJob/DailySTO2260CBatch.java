...
public class DailySTO2260CBatch {

	private static final String BATCH_JOB_NAME = "dailySTO2260CJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTO2260C", batchParam);
			} catch (Exception e) {
