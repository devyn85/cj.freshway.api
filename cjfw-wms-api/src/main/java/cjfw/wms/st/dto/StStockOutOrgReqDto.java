...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "외부비축재고조회reqDto") 
public class StStockOutOrgReqDto extends CommonDto{
	
    /** 저장 리스트 */
    List<StStockOutOrgResDto> saveList;
    ...
    /** 단가/금액 표시 */
    @Schema(description = "단가/금액 표시", nullable = true, example = "")
