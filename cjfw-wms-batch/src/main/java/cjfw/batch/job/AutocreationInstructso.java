...
public class AutocreationInstructso {

	private final SetParamService setParamService;

	private static final String BATCH_JOB_NAME = "autocreationInstructsoJob";
	...
	@Bean
	public Job autocreationInstructsoJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
                ...
                batchParam.setAVC_IFID("COM0430");
				commonDao.selectOne("autocreationInstructsoService.callProcExecute", batchParam);

                batchParam.setAVC_IFID("SD0430");
                commonDao.selectOne("autocreationInstructsoService.callProcExecute", batchParam);
			} catch (Exception e) {
