...
public class KpDailyLocationSummaryBatch {

    private static final String BATCH_JOB_NAME = "kpDailyLocationSummaryJob";
	...
	@Bean
	public Job kpDailyLocationSummaryJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("kpDailyLocationSummaryService.callProcExecute", batchParam);
			} catch (Exception e) {
