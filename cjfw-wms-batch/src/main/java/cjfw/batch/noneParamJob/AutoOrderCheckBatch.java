...
public class AutoOrderCheckBatch {

	private static final String BATCH_JOB_NAME = "autoOrderCheckJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "autoOrderCheck", batchParam);
			} catch (Exception e) {
