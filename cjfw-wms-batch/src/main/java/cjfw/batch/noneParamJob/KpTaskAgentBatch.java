...
public class KpTaskAgentBatch {

	private static final String BATCH_JOB_NAME = "kpTaskAgentJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "kpTaskAgent", batchParam);
			} catch (Exception e) {
