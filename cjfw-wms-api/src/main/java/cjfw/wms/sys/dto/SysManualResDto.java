 ...
 */
@Data
@Schema(description = "매뉴얼 응답")
public class SysManualResDto {
	/** 프로그램코드 */
	...
	@Schema(description = "Grid 표현시 rowId(프로그램코드)", nullable = false, example = "WM10251010")
	private String rowId;
	
	/** Grid Tree 참조용 상위 프로그램코드 */
	@Schema(description = "Grid Tree 참조용 상위 프로그램코드", example = "WM102510")
	private String refUpperProgCd;
	
	/** Grid Tree 참조용 상위 프로그램 */
	@Schema(description = "Grid Tree 참조용 상위 프로그램", example = "0101040101")
	private String refUpperProgNo;
	
	/** 첨부파일개수 */
	@Schema(description = "첨부파일개수", example = "")
