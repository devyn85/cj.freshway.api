...
public class MsRiceSkuHisBatch {
	...
	@Bean
	public Job msRiceSkuHisJob() {
		return new JobBuilder("msRiceSkuHisJob", jobRepository) //
		...
		return (contribution, chunkContext) -> {
			// 배치수행로그
						BatchLogParamsDto batchLogDto = BatchLogParamsDto.builder()
								...
								.jobName("msRiceSkuHisJob") // 이름 바꾸고
								.jobDiv("JAVA")
								.nodeLevel(0)
								.jobStatus("START")
								.command("")
			...
			try {
                ...
                paramMap.put("AVC_IFID", "ID234");
                paramMap.put("AVC_IFRESULT", "");  
                commonDao.delete("msRiceSkuHisService.insertRiceSkuHis", paramMap); // 
