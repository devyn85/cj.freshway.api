...
@Schema(description = "GPS좌표등록 요청 DTO")
public class MsCustDeliveryInfoReqDto extends CommonProcedureDto {
    ...
    private String parkingheight; // as is PARKINGHEIGHT

    /** 업장 출입 방법 */
    @Schema(description = "업장 출입 방법", example = "")
    private String accessway; // as is MOVEMENTENTRY

    /** 적재위치(냉동) */
    @Schema(description = "적재위치(냉동)", example = "")
    private String freezeplace; // as is GOODSLOCATIONFROZEN

    /** 적재위치(냉장/상온) */
    @Schema(description = "적재위치(냉장/상온)", example = "")
    private String coldplace; // as is GOODSLOCATIONREFRIG

    /** 적재위치(상온) */
    @Schema(description = "적재위치(상온)", example = "")
    private String htemperature; // as is GOODSLOCATIONROOM

    /** wms회수위치 */
    @Schema(description = "wms회수위치", example = "")
    private String loadplace2; // as is RETURNLOCATION
    ...
    private String reqdlvtime2From; // as is DELIVERYREQUESTTIMESTART

    /** 배송요구시간2차 종료 */
    @Schema(description = "배송요구시간2차 종료", example = "")
    private String reqdlvtime2To; // as is DELIVERYREQUESTTIMEEND
    ...
    private String inspectorprintyn; // as is INSPECTORPRINTYN

    /** 검수 실무자 전화번호 */
    @Schema(description = "검수 실무자 전화번호", example = "")
    private String inspectionworkerphone; // as is INSPECTIONWORKERPHONE
    ...
    private String deliverynotiyn; // as is DELIVERYNOTIYN
    ...
    private String deliverynotitimestart; // as is DELIVERYNOTITIMESTART

    /** 배송도착 알림 수신 시간 종료 */
    @Schema(description = "배송도착 알림 수신 시간 종료", example = "")
    private String deliverynotitimeend; // as is DELIVERYNOTITIMEEND

    /** 배송도착 알림 수신 휴대폰 번호 */
    @Schema(description = "배송도착 알림 수신 휴대폰 번호", example = "")
    private String deliverynotiphone; // as is DELIVERYNOTIPHONE
    ...
    private String deliverytype; // as is DELIVERYTYPE

    /** 라벨 출력 유형 */
    @Schema(description = "라벨 출력 유형", example = "")
    private String labelprinttype; // as is LABELPRINTTYPE

    /** 온도기록지 제출 대상 여부 */
    @Schema(description = "온도기록지 제출 대상 여부", example = "")
    private String temptarget; // as is TEMPTARGET
    ...
    private String initrequestdt; // as is INITREQUESTDT

    /** 초도배송 요청시간 시작 */
    @Schema(description = "초도배송 요청시간 시작", example = "")
    private String initrequesttimestart; // as is INITREQUESTTIMESTART

    /** 초도배송 요청시간 종료 */
    @Schema(description = "초도배송 요청시간 종료", example = "")
    private String initrequesttimeend; // as is INITREQUESTTIMEEND

    /** 초도배송 대면검수 여부 */
    @Schema(description = "초도배송 대면검수 여부", example = "")
    private String initftfinspectionyn; // as is FTFINSPECTIONYN

    /** 초도배송 담당자 연락처 */
    @Schema(description = "초도배송 담당자 연락처", example = "")
    private String initdeliverycontact; // as is INITDELIVERYCONTACT

    /** 초도배송시 전달사항 */
    @Schema(description = "초도배송시 전달사항", example = "")
    private String initdeliverydesc; // as is INITDELIVERYDESC
    
    /** 고객사 출입 key 세부정보 */
    @Schema(description = "고객사 출입 key 세부정보", example = "")
    private String keydetail; // as is KEYDETAIL
    ...
    private String buildingopentime; // as is BUILDINGOPENTIME

    /** 고객사 납품 가능 시간 */
    @Schema(description = "고객사 납품 가능 시간", example = "")
    private String deliveryavailabletime; // DELIVERYAVAILABLETIME
    ...
    @MultiSearch
    @Schema(description = "실착지코드명", example = "")
    private List<List<String>> truthcustkeyMulti;
    
    /** 실착지 주소 */
    @Schema(description = "실착지 주소", example = "")
    private String truthaddress1; // as is ARRIVALADDRESS
    
    /** 실착지 상세주소 */
    @Schema(description = "실착지 상세주소", example = "")
    private String truthaddress2; // as is ARRIVALDETAILADDRESS
    
    /** 실착지 우편번호 */
    @Schema(description = "실착지 우편번호", example = "")
    private String truthzipcode; // as is ARRIVALPOSTALCODE
    ...
    /** 데이터번호 */
    @Schema(description = "데이터번호_고객정보수신", example = "")
	...
	/** crmSendFlag */
	@Schema(description = "crmSendFlag", example = "")
	private String crmSendFlag;
    ...
    /** 확정 요청: 선택된 파일 SERIALKEY 목록 */
    @Schema(description = "선택 파일 SERIALKEY 목록", example = "")
