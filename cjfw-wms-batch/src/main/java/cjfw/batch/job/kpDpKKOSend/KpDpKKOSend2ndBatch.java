...
public class KpDpKKOSend2ndBatch {

    private static final String BATCH_JOB_NAME = "kpDpKKOSend2ndJob";
    ...
    public Tasklet execTasklet() {
        return (contribution, chunkContext) -> {
            ...
            try {
                ...
                kpDpKKOSendBatchService.inspectAutoSms2th(batchParam, batchLogDto);
            } catch (Exception e) {
