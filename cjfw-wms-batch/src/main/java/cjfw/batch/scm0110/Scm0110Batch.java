...
public class Scm0110Batch {

	private static final String BATCH_JOB_NAME = "scm0110Job";
	private final CommonDao commonDao;

	private final Scm0110BatchService scm0110BatchService;
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				scm0110BatchService.callScm0110JobService(batchParam, batchLogDto); 
