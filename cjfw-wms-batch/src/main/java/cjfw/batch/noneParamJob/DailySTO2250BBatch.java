...
public class DailySTO2250BBatch {

	private static final String BATCH_JOB_NAME = "dailySTO2250BJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTO2250B", batchParam);
			} catch (Exception e) {
