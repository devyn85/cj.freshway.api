...
public class DailySTO2260ABatch {

	private static final String BATCH_JOB_NAME = "dailySTO2260AJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTO2260A", batchParam);
			} catch (Exception e) {
