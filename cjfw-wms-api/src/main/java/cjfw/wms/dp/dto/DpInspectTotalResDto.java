 ...
 */
@Data
@Schema(description = "입고검수처리 총량 조회")
public class DpInspectTotalResDto {
    ...
    @Schema(description = "채널", example = "1")
    ...
    @Schema(description = "전표 일자", example = "20220523")
    private String slipDt;

    @Schema(description = "전표 번호", example = "IV0010872495")
