 ...
 */
@Data
@Schema(description = "차량별분배 상세 결과")
public class WdAllocationBatchGroupResTab4DetailDto extends CommonDto {
	/** 커스텀 엑스트라 체크박스 */
	 ...
	 * 차량번호
	 */
	@Schema(description = "차량번호", example = "01수0011")
