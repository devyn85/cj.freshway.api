...
public class wdClaimInfoDetailBatch {
	private static final String BATCH_JOB_NAME = "wdClaimInfoDetailJob"; 
	...
	@Bean
	public Job wdClaimInfoDetailJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				batchLogDto.setLineNo("84");
                Map<String, Object> paramMap = new java.util.HashMap<>();
                paramMap.put("AVC_IFID", "COM3100");
                paramMap.put("AVC_IFRESULT", "");  
                commonDao.selectOne("wdClaimInfoDetailService.saveClaiminfoDetail", paramMap);
