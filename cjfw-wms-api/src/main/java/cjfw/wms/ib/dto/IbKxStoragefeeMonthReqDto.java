 ...
 * @date        : 2025.11.05
 * @description : 일별 보관료 계산 REQ DTO Class
 * @issues      :
 * -----------------------------------------------------------
 ...
 */
@Schema(description = "일별 보관료 계산 REQ DTO")

@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class IbKxStoragefeeMonthReqDto extends CommonProcedureDto {
	List<IbKxStoragefeeMonthReqDto> saveList;
