...
public class StTplOnhandQtyService {

    private transient static final String SERVICEID_PREFIX = "stTplOnhandQtyService."; 
     ...
     */
    public List<StTplOnhandQtyResDto> getMasterList(StTplOnhandQtyReqDto reqDto) {
