...
public class OmAutoOrderSetupReqDto extends CommonProcedureDto {
    ...
    @MultiSearch
    @Schema(description = "공급센터코드", example = "")
    private List<String> frDccodeMulti;
    ...
    @MultiSearch
    @Schema(description = "공급받는센터", example = "")
    private List<String> toDccodeMulti;
    ...
    private String rowIndex;	// grid 체크 index
