...
public class WeeklyPurchaseStatsBatch {

	private static final String BATCH_JOB_NAME = "weeklyPurchaseStatsJob";
	...
	@Bean
	public Job weeklyPurchaseStatsJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "weeklyPurchaseStats", batchParam);
			} catch (Exception e) {
