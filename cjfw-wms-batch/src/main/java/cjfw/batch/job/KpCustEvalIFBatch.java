...
public class KpCustEvalIFBatch {

    private static final String BATCH_JOB_NAME = "kpCustEvalIFJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				int cnt = commonDao.insert("kpCustEvalIFService.saveConfirm", batchParam);

				rtnMsg = "IF_VENDOR_QUALITY INSERT COUNT: " + String.valueOf(cnt);
				...
				//batchLogDto.setResultMsg(batchLogDto.getResultMsg() + rtnMsg) //PKG,SP 호출 없음 (직접 INSERT문 수행)
