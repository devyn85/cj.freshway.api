 ...
 * @date : 2025.10.24
 * @description : 기준정보 > 물류센터 정보 > 결품대응 POP그룹 관리 Response DTO Class
 * @issues :
 *
 *         <pre>
 * -----------------------------------------------------------
 ...
 *         </pre>
 */
@Schema(description = "기준정보 > 물류센터 정보 > 결품대응 POP그룹 관리 Response DTO")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class MsWdAppResDto extends CommonProcedureDto {
