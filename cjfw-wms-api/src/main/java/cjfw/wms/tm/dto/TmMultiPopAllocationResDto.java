 ...
 * @date : 2025.06.23
 * @description : 거래처별이중 POP 배차 현황 조회 결과 DTO 
 * @issues : 
 * ----------------------------------------------------------- 
 ...
 */
@Data
@Schema(description = "거래처별이중 POP 배차 현황 조회 결과")
public class TmMultiPopAllocationResDto {
    ...
    /** 중량 */
    @Schema(description = "체적", nullable = false, example = "")
