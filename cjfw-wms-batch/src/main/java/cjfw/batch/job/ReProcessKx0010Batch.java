...
public class ReProcessKx0010Batch {

    private static final String BATCH_JOB_NAME = "reProcessKx0010Job";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("reProcessKx0010Service.callProcExecute", batchParam);
			} catch (Exception e) {
