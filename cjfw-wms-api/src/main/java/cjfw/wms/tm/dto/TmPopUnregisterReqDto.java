 ...
 * @date : 2025.06.02 
 * @description : 거래처별 POP 미등록 현황 요청 DTO 
 * @issues : 
 * ----------------------------------------------------------- 
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "거래처별 POP 미등록 현황 요청") 
public class TmPopUnregisterReqDto extends CommonDto {
    /** 저장 리스트 */
    List<TmPopUnregisterDeliveryResDto> saveList;
	...
	/** 거래처유형 */
	@Schema(description = "거래처유형", nullable = false, example = "")
