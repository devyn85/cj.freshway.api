...
public class DailyInoutBatch {

	private static final String BATCH_JOB_NAME = "dailyInoutJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("dailyInoutService.callProcExecute", batchParam);
			} catch (Exception e) {
