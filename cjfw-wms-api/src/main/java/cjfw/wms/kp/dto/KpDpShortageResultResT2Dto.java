 ...
 * @date : 2025.09.08
 * @description : 지표 > 센터 운영 > 입고 결품 현황 저장_탭 Response DTO Class
 * @issues :
 *
 *         <pre>
 * -----------------------------------------------------------
 ...
 *         </pre>
 */
@Schema(description = "지표 > 센터 운영 > 입고 결품 현황 저장_탭 Response DTO")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class KpDpShortageResultResT2Dto extends CommonProcedureDto {
