 ...
 * @date : 2025.08.08
 * @description : IF_IB_STOCKSKU_FILE 테이블 조회 결과 DTO 
 * @issues : 
 * ----------------------------------------------------------- 
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "IF_IB_STOCKSKU_FILE 테이블 조회 결과") 
public class IfIbStockskuFileDto extends CommonProcedureDto {	
