...
public class DailySTO2250EBatch {

	private static final String BATCH_JOB_NAME = "dailySTO2250EJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTO2250E", batchParam);
			} catch (Exception e) {
