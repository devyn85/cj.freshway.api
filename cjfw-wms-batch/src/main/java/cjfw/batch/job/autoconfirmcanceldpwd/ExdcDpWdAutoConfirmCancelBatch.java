...
public class ExdcDpWdAutoConfirmCancelBatch {

	private static final String BATCH_JOB_NAME = "autoconfirmcanceldpwdJob";
	private final CommonDao commonDao;

	private final SetParamService setParamService;

    private final ExdcDpWdAutoConfirmCancelService exdcDpWdAutoConfirmCancelService;
	...
	@Bean
	public Job autoconfirmcanceldpwdJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
                ...
                exdcDpWdAutoConfirmCancelService.callAutoConfirmCancelService(batchParam, batchLogDto);
