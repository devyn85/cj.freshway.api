...
public class WdDeliveryLabelResTab1ReportDto extends CommonDto{
	/** 커스텀 엑스트라 체크박스 */
     ...
     * 상품
     */
    @Schema(description = "상품", example = "SKU00123")
    private String sku;
    /**
     * 상품명
     */
    @Schema(description = "상품명", example = "샘플상품명")
    private String skuname;
    /**
     * 거래처코드
     */
    @Schema(description = "거래처코드", example = "CUST001")
