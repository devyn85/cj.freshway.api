...
public class wdClaimInfoVSRBatch {
    private static final String BATCH_JOB_NAME = "wdClaimInfoVSRJob";
    ...
    public Tasklet execTasklet() {
        return (contribution, chunkContext) -> {
            ...
            try {
                ...
                paramMap.put("AVC_IFID", "COM3110");
                paramMap.put("AVC_IFRESULT", "");
                commonDao.selectOne("wdClaimInfoVSRService.saveClaiminfoVSR", paramMap);
