...
import cjfw.batch.shr0130.SmsSendBatchService;
...
public class SmsSendKkoBatch {

    private static final String BATCH_JOB_NAME = "smsSendKkoJob";
	private final CommonDao commonDao;
	private final SetParamService setParamService;
    private final SmsSendKkoBatchService smsSendKkoBatchService;
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
                ...
                smsSendKkoBatchService.callSmsSendKkoJobService(batchParam, batchLogDto);
            } catch (Exception e) {
