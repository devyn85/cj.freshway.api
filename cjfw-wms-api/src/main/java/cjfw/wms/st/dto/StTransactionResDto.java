 ...
 * @date : 2025.06.02 
 * @description : 이력재고처리현황 Response DTO 
 * @issues :<pre> 
 * ----------------------------------------------------------- 
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "이력재고처리현황 Response DTO")
public class StTransactionResDto {
	...
	@Schema(description = "계산박스수")
	private BigDecimal calbox;

	@Schema(description = "실주문박스수")
	private BigDecimal realorderbox;

	@Schema(description = "실확정박스수")
