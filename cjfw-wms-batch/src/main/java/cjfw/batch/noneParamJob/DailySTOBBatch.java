...
public class DailySTOBBatch {

	private static final String BATCH_JOB_NAME = "dailySTOBJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTOB", batchParam);
			} catch (Exception e) {
