 ...
 */
@Data
@Schema(description = "중계영업확정처리 상세 조회 결과")
public class StConvertCFMDetailResDto extends CommonProcedureDto {
	/** 커스텀 엑스트라 체크박스 */
    ...
    /** 임박여부 */
    @Schema(description = "임박여부", nullable = false, example = "")
    private String neardurationyn2;
    ...
    /** 입수량 */
    @Schema(description = "입수량", nullable = false, example = "")
    private BigDecimal qtyperbox;
    
    /** 입수량 */
    @Schema(description = "입수량", nullable = false, example = "")
    private BigDecimal qtyperbox2;
    ...
    /** 박스 */
    @Schema(description = "박스", nullable = false, example = "")
    ...
    /** 저장명 */
    @Schema(description = "저장명", nullable = false, example = "")
    ...
    /** 생성일 */
    @Schema(description = "생성일", nullable = false, example = "")
    ...
    /** 취소사유 */
    @Schema(description = "취소사유", nullable = false, example = "")
