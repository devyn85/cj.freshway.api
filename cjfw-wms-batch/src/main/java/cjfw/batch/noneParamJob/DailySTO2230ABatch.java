...
public class DailySTO2230ABatch {

	private static final String BATCH_JOB_NAME = "dailySTO2230AJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTO2230A", batchParam);
			} catch (Exception e) {
