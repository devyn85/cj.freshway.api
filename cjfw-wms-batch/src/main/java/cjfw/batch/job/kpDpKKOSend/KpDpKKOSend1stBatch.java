...
import cjfw.batch.job.smsSendKko.SmsSendKkoBatchService;
...
public class KpDpKKOSend1stBatch {

    private static final String BATCH_JOB_NAME = "kpDpKKOSend1stJob";
    private final CommonDao commonDao;
    private final SetParamService setParamService;
    private final KpDpKKOSendBatchService kpDpKKOSendBatchService;
