 ...
 * @date : 2025.09.29 
 * @description : 이력STO출고처리-결품대상 상세 결과 DTO
 * @issues :<pre> 
 * ----------------------------------------------------------- 
 ...
 */
@Data
@Schema(description = "이력STO출고처리-결품대상 상세 결과")
public class WdSerialOrderSTOResTab2ShortageDto extends CommonDto{
	/** 커스텀 엑스트라 체크박스 */
     ...
     * 결품사유
     */
    @Schema(description = "결품사유", example = "SKU_ERROR")
    private String reasoncode;
    /**
     * 결품처리결과(TEXT)
     */
    @Schema(description = "결품처리결과(TEXT)", example = "재고부족")
     ...
     * tasksystem
     */
    @Schema(description = "tasksystem", example = "CANCEL")
