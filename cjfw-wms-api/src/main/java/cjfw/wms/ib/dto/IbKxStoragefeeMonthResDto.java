 ...
 * @date        : 2025.11.05
 * @description : 일별 보관료 계산 RES DTO Class
 * @issues      :
 * -----------------------------------------------------------
 ...
 */
@Schema(description = "일별 보관료 계산 RES DTO")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class IbKxStoragefeeMonthResDto extends CommonProcedureDto {
