...
@Schema(description = "협력사 검색 요청")
public class CmSearchPartnerPopupReqDto extends CommonDto{
	@Schema(description = "협력사코드/명", nullable = false, example = "1006411")
	private String name;
