 ...
 * @date : 2025.07.31
 * @description : 재고일괄이동 Request DTO Class
 * @issues :
 *         <pre>
 * -----------------------------------------------------------
 ...
 */
@Data
@Schema(description = "재고일괄이동 Request DTO")
public class StLocMoveReqDto extends CommonProcedureDto {
	/** 메인그리드 저장 리스트 */
	List<StLocMoveResDto> saveList;	
