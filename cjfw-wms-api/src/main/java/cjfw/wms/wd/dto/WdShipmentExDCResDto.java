 ...
 * @date : 2025.06.30 
 * @description : 외부비축출고처리 조회 결과 DTO
 * @issues :<pre> 
 * ----------------------------------------------------------- 
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "외부비축출고처리 조회 결과") 
public class WdShipmentExDCResDto extends CommonProcedureDto {
    /** 데이터번호 */
    ...
    /** 운송료(공급가) */
    @Schema(description = "운송료(공급가)", nullable = true, example = "")
    private java.math.BigDecimal trandeliverypricepre;
    ...
    /** 주문수량 */
    @Schema(description = "영업주문수량", nullable = true, example = "")
    private java.math.BigDecimal orgorderqty;
    ...
    /** SCM사용자아이디 */
    @Schema(description = "SCM사용자아이디", nullable = true, example = "")
    private String userId;
    
    /** SCM사용자명 */
    @Schema(description = "SCM사용자명", nullable = true, example = "")
    ...
    /** 입고예정상태 */
    @Schema(description = "입고예정상태", nullable = true, example = "")
    private String dpInplanStatus;
