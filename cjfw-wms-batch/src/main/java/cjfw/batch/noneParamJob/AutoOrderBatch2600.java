...
public class AutoOrderBatch2600 {

	private static final String BATCH_JOB_NAME = "autoOrderBatch2600Job";
	...
	@Bean
	public Job autoOrderBatch2600Job() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "autoOrderBatch2600", batchParam);
			} catch (Exception e) {
