...
public class ExdcRealRtConfirmBatch {

    private static final String BATCH_JOB_NAME = "exdcRealRtConfirmJob";
	...
	@Bean
	public Job exdcRealRtConfirmJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("exdcRealRtConfirmService.callProcExecute", batchParam);
			} catch (Exception e) {
