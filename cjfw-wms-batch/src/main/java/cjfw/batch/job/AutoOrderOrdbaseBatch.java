...
public class AutoOrderOrdbaseBatch {

    private static final String BATCH_JOB_NAME = "autoOrderOrdbaseJob";
	...
	@Bean
	public Job autoOrderOrdbaseJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				// 배치 실행 패키지 호출.
				commonDao.selectOne("autoOrderOrdbaseService.callProcExecute", batchParam);
			} catch (Exception e) {
