...
public class DailySTOD2250Batch {

	private static final String BATCH_JOB_NAME = "dailySTOD2250Job";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTOD2250", batchParam);
			} catch (Exception e) {
