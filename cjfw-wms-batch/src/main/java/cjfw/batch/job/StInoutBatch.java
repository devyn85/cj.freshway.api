...
public class StInoutBatch {

    private static final String BATCH_JOB_NAME = "stInoutJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("stInoutService.callProcExecute", batchParam);
			} catch (Exception e) {
