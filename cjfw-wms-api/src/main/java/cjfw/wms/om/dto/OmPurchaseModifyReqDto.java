 ...
 * @date        : 2025.09.12
 * @description : 저장품발주삭제 기능을 구현한 Req DTO Class
 * @issues      :
 * -----------------------------------------------------------
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "저장품발주삭제 요청") 
public class OmPurchaseModifyReqDto extends CommonProcedureDto {
	/** 메인그리드 저장 리스트 */
	List<OmPurchaseModifyReqDto> saveList;
	
	@Schema(description = "멀티 물류센터 코드", example = "2600")
    private String multiDcCode[];
	
	@Schema(description = "멀티 물류센터 코드", example = "2600")
    private String fromMultiDcCode[];
    ...
    @Schema(description = "변경 전표 일자", example = "20250912")
    private String modSlipDt;
    ...
    @Schema(description = "변경입고일자", example = "20250912")
