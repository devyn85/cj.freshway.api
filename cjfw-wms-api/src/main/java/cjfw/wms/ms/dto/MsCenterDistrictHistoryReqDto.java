...
@Schema(description = "센터 권역 이력 요청 DTO")
public class MsCenterDistrictHistoryReqDto extends CommonDto {
	...
	@Schema(description = "조회조건 행정동 코드")
	private String searchHjdongCd;
	
	@Schema(description = "조회조건 행정동명")
	private String searchHjdongNm;
	
	@Schema(description = "조회조건 센터", hidden = true)
