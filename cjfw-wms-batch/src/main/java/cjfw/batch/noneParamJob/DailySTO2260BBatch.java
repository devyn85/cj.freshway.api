...
public class DailySTO2260BBatch {

	private static final String BATCH_JOB_NAME = "dailySTO2260BJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTO2260B", batchParam);
			} catch (Exception e) {
