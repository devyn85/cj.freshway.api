...
public class DailySTO2250ABatch {

	private static final String BATCH_JOB_NAME = "dailySTO2250AJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTO2250A", batchParam);
			} catch (Exception e) {
