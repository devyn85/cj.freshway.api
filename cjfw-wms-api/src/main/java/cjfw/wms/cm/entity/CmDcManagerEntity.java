 ...
 */
@Data
public class CmDcManagerEntity extends CommonDto {
    @Schema(description = "센터코드 (PK)", requiredMode = Schema.RequiredMode.REQUIRED, maxLength = 14)
