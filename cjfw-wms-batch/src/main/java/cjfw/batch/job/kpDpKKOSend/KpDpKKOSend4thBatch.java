...
public class KpDpKKOSend4thBatch {

    private static final String BATCH_JOB_NAME = "kpDpKKOSend4thJob";
    ...
    public Tasklet execTasklet() {
        return (contribution, chunkContext) -> {
            ...
            try {
                ...
                kpDpKKOSendBatchService.inspectAutoSms4th(batchLogDto);
            } catch (Exception e) {
