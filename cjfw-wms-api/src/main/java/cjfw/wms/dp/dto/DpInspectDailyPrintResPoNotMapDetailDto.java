 ...
 * @date : 2025.07.10
 * @description : 일배입고검수출력 PO 미맵핑 Detail Response DTO Class
 * @issues :
 *
 *         <pre>
 * -----------------------------------------------------------
 ...
 *         </pre>
 */
@Schema(description = "일배입고검수출력 PO 미맵핑 Detail Response DTO")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class DpInspectDailyPrintResPoNotMapDetailDto {
	/** 커스텀 엑스트라 체크박스 */
