...
public class MgmtTempTableCleanBatch {

	private static final String BATCH_JOB_NAME = "mgmtTempTableCleanJob";
	...
	@Bean
	public Job mgmtTempTableCleanJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "mgmtTempTableCleanJobs", batchParam);
			} catch (Exception e) {
