...
public class DailySTOABatch {

	private static final String BATCH_JOB_NAME = "dailySTOAJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTOA", batchParam);
			} catch (Exception e) {
