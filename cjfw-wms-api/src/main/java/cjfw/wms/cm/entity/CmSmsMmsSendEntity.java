 ...
 */
@Data
public class CmSmsMmsSendEntity {
	/** 데이터번호 */
    ...
    /** TEMPLATE_CODE */
    @Schema(description = "템플릿코드", example = "")
    ...
    /** FAILED_TYPE */
    @Schema(description = "FAILED_TYPE", example = "LMS")
    private String failType;
    
    /** PROFILE_KEY */
    @Schema(description = "PROFILE_KEY", example = "")
    private String profileKey;
    
    /** KKO_TYPE */
    @Schema(description = "KKO_TYPE", example = "")
    private String kkoType;
