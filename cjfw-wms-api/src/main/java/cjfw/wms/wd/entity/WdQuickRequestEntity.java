...
public class WdQuickRequestEntity extends CommonProcedureDto {
	/** IF데이터번호 */
 ...
 // Add these fields to WdQuickRequestEntity

    /** voc량 */
    @Schema(description = "voc량")
    private String vocQty;
    ...
    /** 협력사코드(PO) */
    @Schema(description = "협력사코드(PO)")
    private String poCustkey;

    /** 협력사연락처(PO) */
    @Schema(description = "협력사연락처(PO)")
    private String poCustTel;

    /** 도착지 방문순서 */
    @Schema(description = "도착지 방문순서")
    private BigDecimal toSeq;
