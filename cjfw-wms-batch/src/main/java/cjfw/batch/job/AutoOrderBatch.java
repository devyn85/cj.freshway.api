...
public class AutoOrderBatch {

    private static final String BATCH_JOB_NAME = "autoOrderJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				// 배치 실행 패키지 호출.
				commonDao.selectOne("autoOrderService.callProcExecute", batchParam);
			} catch (Exception e) {
