 ...
 * @date : 2025.08.11 
 * @description : 비용기표 DocumentInfo Detail Entity
 * @issues :<pre> 
  * ----------------------------------------------------------- 
 ...
 */
@Data
public class IbExpenseDocumentDetailPopupEntity extends CommonProcedureDto {    
    ...
    private BigDecimal exchangeTypeId;
