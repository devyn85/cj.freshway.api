...
public class DailySTOD2600Batch {

	private static final String BATCH_JOB_NAME = "dailySTOD2600Job";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTOD2600", batchParam);
			} catch (Exception e) {
