...
public class Scm0320Batch {

	private static final String BATCH_JOB_NAME = "scm0320Job";
	private final CommonDao commonDao;

	private final Scm0320BatchService scm0320BatchService;
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				scm0320BatchService.callScm0320JobService(batchParam, batchLogDto);
