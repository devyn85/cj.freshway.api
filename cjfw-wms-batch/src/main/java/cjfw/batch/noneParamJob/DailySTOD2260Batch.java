...
public class DailySTOD2260Batch {

	private static final String BATCH_JOB_NAME = "dailySTOD2260Job";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTOD2260", batchParam);
			} catch (Exception e) {
