 ...
 * @author : ParkJinWoo 
 * @date : 2025.07.11 
 * @description :외부비축재고변경사유현황 상세 조회기능을 구현한 Controller Class 
 * @issues : 
 * ----------------------------------------------------------- 
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "외부비축재고변경사유현황 상세 조회 조건 DTO")
public class MgModifyLogExDcDetailListReqDto extends CommonDto {
