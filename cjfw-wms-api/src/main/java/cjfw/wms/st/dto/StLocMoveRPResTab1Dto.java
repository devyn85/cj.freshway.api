 ...
 */
@Data
@Schema(description = "보충생성 결과")
public class StLocMoveRPResTab1Dto extends CommonProcedureDto {
    ...
    private BigDecimal openqtyBox; // AS OPENQTY_BOX -> openqtyBox (언더바 있으므로 카멜 케이스)
    @Schema(description = "EA", example = "3")
    private BigDecimal openqtyEa; // AS OPENQTY_EA -> openqtyEa (언더바 있으므로 카멜 케이스)
