...
public class Scm0110StoBatch {

	private static final String BATCH_JOB_NAME = "scm0110StoJob";
	private final CommonDao commonDao;

	private final Scm0110StoBatchService scm0110StoBatchService;
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				scm0110StoBatchService.callScm0100StoJobService(batchParam, batchLogDto);
