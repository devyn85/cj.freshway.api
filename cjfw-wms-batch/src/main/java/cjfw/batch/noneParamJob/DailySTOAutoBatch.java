...
public class DailySTOAutoBatch {

	private static final String BATCH_JOB_NAME = "dailySTOAutoBatchJob";
	...
	@Bean
	public Job dailySTOAutoBatchJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTOAuto", batchParam);
			} catch (Exception e) {
