...
public class AutoOrderBatch2600A {

	private static final String BATCH_JOB_NAME = "autoOrderBatch2600AJob";
	...
	@Bean
	public Job autoOrderBatch2600AJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "autoOrderBatch2600A", batchParam);
			} catch (Exception e) {
