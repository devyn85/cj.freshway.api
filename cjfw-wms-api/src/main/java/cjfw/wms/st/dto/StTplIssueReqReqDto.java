...
@Data
public class StTplIssueReqReqDto extends CommonProcedureDto {
    
    /** 저장 리스트 */
    List<StTplIssueReqResDto> saveList;
    ...
    /** to고객 */
    @Schema(description = "to고객")
    private String toCustkey;
    
    /** from고객 */
    @Schema(description = "from고객")
