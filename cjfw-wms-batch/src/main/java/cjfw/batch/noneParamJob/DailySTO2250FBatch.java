...
public class DailySTO2250FBatch {

	private static final String BATCH_JOB_NAME = "dailySTO2250FJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTO2250F", batchParam);
			} catch (Exception e) {
