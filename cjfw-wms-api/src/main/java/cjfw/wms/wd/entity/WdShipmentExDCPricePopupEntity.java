 ...
 * @date : 2025.11.13 
 * @description : 외부비축출고처리 운임 Entity
 * @issues :<pre> 
 * ----------------------------------------------------------- 
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "외부비축출고처리 운임 Entity") 
public class WdShipmentExDCPricePopupEntity extends CommonProcedureDto {
    ...
    private BigDecimal serialkeyGroup;
