...
public class DailySTO2800CBatch {

	private static final String BATCH_JOB_NAME = "dailySTO2800CJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTO2800C", batchParam);
			} catch (Exception e) {
