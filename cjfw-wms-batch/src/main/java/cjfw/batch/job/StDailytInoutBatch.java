...
public class StDailytInoutBatch {

    private static final String BATCH_JOB_NAME = "stDailytInoutJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("stDailytInoutService.callProcExecute", batchParam);
			} catch (Exception e) {
