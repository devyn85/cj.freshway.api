...
public class MspurchasemstOutBatch {

    private static final String BATCH_JOB_NAME = "mspurchasemstOutJob";
	...
	@Bean
	public Job mspurchasemstOutJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("mspurchasemstOutService.callProcExecute", batchParam);
			} catch (Exception e) {
