 ...
 * @date        : 2025.08.26
 * @description : 커뮤니티 게시판 Entity
 * @issues      :
 * -----------------------------------------------------------
 * DATE              AUTHOR             MAJOR_ISSUE
 * -----------------------------------------------------------
 * 2025.08.26        JiSooKim (jskim14@cj.net)       생성
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "커뮤니티 게시판 Entity")
public class CbCommunityEntity extends CommonTriggerDto {
    /** 시리얼키 */
