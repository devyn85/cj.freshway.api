...
public class DailySTO2250CBatch {

	private static final String BATCH_JOB_NAME = "dailySTO2250CJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTO2250C", batchParam);
			} catch (Exception e) {
