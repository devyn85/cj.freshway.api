...
@NoArgsConstructor 
@AllArgsConstructor
@Schema(description = "피킹그룹정보 조회 결과 DTO")
public class MsPickBatchGroupResDto {
    ...
    @Schema(description = "거리 유형명")
    private String distanceTypeNm;
