...
public class SkuControlRemoveBatch {

    private static final String BATCH_JOB_NAME = "skuControlRemoveJob";
	...
	@Bean
	public Job skuControlRemoveJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
                ...
                batchParam.setAVC_SYSTEM("Batch");
                batchParam.setAVC_COMMAND("CONTROL_REMOVE_BATCH");
                batchParam.setAVC_WORKER("ControlRemoveBatch");
				commonDao.selectOne("skuControlRemoveService.callProcExecute", batchParam);
			} catch (Exception e) {
