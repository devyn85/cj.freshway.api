 ...
 *         </pre>
 */
@Schema(description = "입고확정처리 Detail Response DTO")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class DpReceiptResDetailDto {
	/** 커스텀 엑스트라 체크박스 */
	...
	/** docORDERQTY */
	@Schema(description = "docORDERQTY")
	private String docorderqty;
	...
	/** SHORTAGEQTY_WD */
	@Schema(description = "SHORTAGEQTY_WD")
	private String shortageqtyWd;
	...
	/** restoqty */
	@Schema(description = "restoqty")
	private String restoqty;

	/** restono */
	@Schema(description = "restono")
	private String restono;
}
