 ...
 * @date : 2025.08.19 
 * @description : 출고재고분배-차량별분배 목록 결과 DTO
 * @issues :<pre> 
 * ----------------------------------------------------------- 
 ...
 */
@Data
@Schema(description = "출고재고분배-차량별분배 목록 결과")
public class WdAllocationBatchGroupResTab4Dto extends CommonDto{
	/** 커스텀 엑스트라 체크박스 */
     ...
     * 차량번호
     */
    @Schema(description = "차량번호", example = "01버7777")
    private String carno;
    
    /**
     * popno
     */
    @Schema(description = "popno", example = "01버7777")
    private String popno;
    
    /**
     * fromdate
     */
    @Schema(description = "fromdate", example = "01버7777")
