...
public class Scm0330Batch {

	private static final String BATCH_JOB_NAME = "scm0330Job";
	private final CommonDao commonDao;

	private final Scm0330BatchService scm0330BatchService;
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				scm0330BatchService.callScm0330JobService(batchParam, batchLogDto);
