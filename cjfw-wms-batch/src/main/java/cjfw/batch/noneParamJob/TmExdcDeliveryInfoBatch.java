...
public class TmExdcDeliveryInfoBatch {
	private static final String BATCH_JOB_NAME = "tmExdcDeliveryInfoJob"; 
	...
	@Bean
	public Job tmExdcDeliveryInfoJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
                ...
                paramMap.put("AVC_IFID", "COM3120");
                paramMap.put("AVC_IFRESULT", "");  
                commonDao.selectOne("tmExdcDeliveryInfoService.saveExdcDeliveryInfo", paramMap);
