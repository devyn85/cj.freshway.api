...
public class DailyPOAutoBatch {

	private static final String BATCH_JOB_NAME = "dailyPOAutoJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailyPoAuto", batchParam);
			} catch (Exception e) {
