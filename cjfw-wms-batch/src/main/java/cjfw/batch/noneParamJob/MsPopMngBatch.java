...
public class MsPopMngBatch {
	...
	@Bean
	public Job msPopMngJob() {
		return new JobBuilder("msPopMngJob", jobRepository)
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
                ...
                commonDao.delete("msPopMngService.deleteMsCustxpop", paramMap);
			} catch (Exception e) {
