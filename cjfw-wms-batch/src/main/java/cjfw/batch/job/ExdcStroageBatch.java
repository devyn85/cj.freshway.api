...
public class ExdcStroageBatch {

    private static final String BATCH_JOB_NAME = "exdcStroageJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("exdcStroageService.callProcExecute", batchParam);
			} catch (Exception e) {
