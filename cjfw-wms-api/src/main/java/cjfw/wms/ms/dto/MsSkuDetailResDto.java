...
@Data
@Builder
@Schema(description = "상품정보 상세 조회 결과 DTO")
public class MsSkuDetailResDto {
    ...
    @Schema(description = "저장 타입 (1-저온, 2-상온 등)")
    ...
    @Schema(description = "상품 유형 (FERT, HAWA, HALB, ROH 등)")
    ...
    @Schema(description = "유통 기간 (중복)")
    private String duration; // 중복 필드이지만 쿼리에서 다시 선택됨

    @Schema(description = "기본 단위 (중복)")
    private String baseUom; // 중복 필드이지만 쿼리에서 다시 선택됨

    @Schema(description = "구매 단위 (중복)")
    private String purchaseUom; // 중복 필드이지만 쿼리에서 다시 선택됨

    @Schema(description = "판매 단위")
    private String salesUom;

    @Schema(description = "회수 단위 (중복)")
    private String returnUom; // 중복 필드이지만 쿼리에서 다시 선택됨

    @Schema(description = "팔레트당 박스 수 (중복)")
    private BigDecimal boxPerPlt; // 중복 필드이지만 쿼리에서 다시 선택됨

    @Schema(description = "박스당 낱개 수 (중복)")
    private BigDecimal qtyPerBox; // 중복 필드이지만 쿼리에서 다시 선택됨
    ...
    @Schema(description = "적재 단당 박스 수 (중복)")
    private BigDecimal boxPerLayer; // 중복 필드이지만 쿼리에서 다시 선택됨

    @Schema(description = "팔레트당 적재 단수 (중복)")
    private BigDecimal layerPerPlt; // 중복 필드이지만 쿼리에서 다시 선택됨

    @Schema(description = "개당 총중량 (Kg)")
    private BigDecimal grossWeight;

    @Schema(description = "개당 실중량 (Kg) (중복)")
    private BigDecimal netWeight; // 중복 필드이지만 쿼리에서 다시 선택됨
    ...
    @Schema(description = "시리얼 관리 여부 (중복)")
    private String serialYn; // 중복 필드이지만 쿼리에서 다시 선택됨
