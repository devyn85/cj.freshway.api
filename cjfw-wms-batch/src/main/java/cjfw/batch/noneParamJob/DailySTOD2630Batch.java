...
public class DailySTOD2630Batch {

	private static final String BATCH_JOB_NAME = "dailySTOD2630Job";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTOD2630", batchParam);
			} catch (Exception e) {
