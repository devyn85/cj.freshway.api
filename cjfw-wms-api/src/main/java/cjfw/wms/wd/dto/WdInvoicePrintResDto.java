 ...
 */
@Data
public class WdInvoicePrintResDto {
	/** 레포트 Header */
	...
	List<WdInvoicePrintDetailResDto> reportCredit;	
	/** 레포트 배송비용 - 상세는 PrintDetailResDto 로 통합	 */
	List<WdInvoicePrintDetailResDto> reportDlvCost;	
	/** 일메모파일 - 상세는 PrintDetailResDto 로 통합	 */
	List<WdInvoicePrintDetailResDto> reportFileList;
	/** CRM정보 - 상세는 PrintDetailResDto 로 통합	 */
	List<WdInvoicePrintDetailResDto> reportCrmCustdlv;		
