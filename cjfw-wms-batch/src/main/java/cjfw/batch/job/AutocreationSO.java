...
public class AutocreationSO {

    private static final String BATCH_JOB_NAME = "autocreationSOJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("autocreationSOService.callProcExecute", batchParam);
