...
public class DailyPoAutoRecreationBatch {

	private static final String BATCH_JOB_NAME = "dailyPoAutoRecreationJob";
	...
	@Bean
	public Job dailyPoAutoRecreationJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailyPoAutoRecreation", batchParam);
			} catch (Exception e) {
