...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "일자별 수당관리 요청 DTO")
public class TmAmountDailyReqDto extends CommonDto {
	...
	private List<TmAmountDailyResDto> saveList;
