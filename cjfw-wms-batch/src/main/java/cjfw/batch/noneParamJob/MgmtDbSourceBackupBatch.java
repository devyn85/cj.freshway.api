...
public class MgmtDbSourceBackupBatch {

	private static final String BATCH_JOB_NAME = "mgmtDbSourceBackupJob";
	...
	@Bean
	public Job mgmtDbSourceBackupJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "mgmtDbSourceBackupJobs", batchParam);
			} catch (Exception e) {
