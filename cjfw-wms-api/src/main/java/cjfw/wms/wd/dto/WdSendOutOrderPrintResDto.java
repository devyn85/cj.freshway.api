 ...
 * @date : 2025.06.10 
 * @description : 외부비축출고지시 인쇄용 조회 결과 DTO
 * @issues :<pre> 
 * ----------------------------------------------------------- 
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "외부비축출고지시 인쇄용 조회 결과") 
public class WdSendOutOrderPrintResDto extends CommonDto {
    
    /** 레포트 Header */
    List<WdSendOutOrderPrintResDto> reportHeader;
    
    /** PRINTKEY */
    @Schema(description = "PRINTKEY", nullable = false, example = "")
    ...
    /** 팩스번호 */
    @Schema(description = "팩스번호", nullable = false, example = "")
    private String recvfaxno2;
    ...
    private String userCotelNo;
    
    /** 핸드폰번호 */
    @Schema(description = "핸드폰번호", nullable = false, example = "")
    private String userHandphoneNo;    
    
    /** 사용자 아이디 */
    @Schema(description = "사용자 아이디", nullable = true, example = "")
    private String userId;

    /** 사용자 이름 */
    @Schema(description = "사용자 이름", nullable = true, example = "")
    private String userNm;

    /** 전화번호1 */
    @Schema(description = "전화번호1", nullable = true, example = "")
    private String phone1;

    /** 전화번호2 */
    @Schema(description = "전화번호2", nullable = true, example = "")
    private String phone2;

    /** 저장 단위 */
    @Schema(description = "저장 단위", nullable = true, example = "")
    private String storeruom;

    /** 행 번호 */
    @Schema(description = "행 번호", nullable = true, example = "")
    private Integer rowcnt;
    
    /** 실착지주소 */
    @Schema(description = "실착지주소", nullable = true, example = "")
    private String deliveryAddr;
    
    /** gSpid */
    @Schema(description = "gSpid", nullable = true, example = "")
    private String spid;
