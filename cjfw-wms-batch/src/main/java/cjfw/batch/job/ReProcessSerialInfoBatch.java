...
public class ReProcessSerialInfoBatch {

    private static final String BATCH_JOB_NAME = "reProcessSerialInfoJob";
	...
	@Bean
	public Job reProcessSerialInfoJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("reProcessSerialInfoService.callProcExecute", batchParam);
			} catch (Exception e) {
