 ...
 * @author : ParkJinWoo 
 * @date : 2025.08.04 
 * @description : 정산항목관리 조회 결과 기능을 구현한 res Class 
 * @issues : 
 * ----------------------------------------------------------- 
...
@NoArgsConstructor            
@AllArgsConstructor
@Schema(description = "정산항목관리 결과 DTO")
public class TmManageEntityMasterListResDto  {
	/** 센터코드 */
    ...
    /** 정산항목명 */
    @Schema(description = "정산항목명 ")
    private String sttlItemName;
    /** 정산항목코드 */
    @Schema(description = "계산타입명 ")
