 ...
 * @date : 2025.08.08
 * @description : IF_IB_STOCKSKU_D 테이블 조회 결과 DTO 
 * @issues : 
 * ----------------------------------------------------------- 
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "IF_IB_STOCKSKU_D 테이블 조회 결과") 
public class IfIbStockskuDDto extends CommonProcedureDto {	
    ...
    /** GL_ACCOUNT */
    @Schema(description = "GL_ACCOUNT", nullable = false, example = "")
    ...
    /** PROFIT_CTR */
    @Schema(description = "PROFIT_CTR", nullable = false, example = "")
    private String profitCtr;

    /** SHKZG */
    @Schema(description = "SHKZG", nullable = false, example = "")
