...
public class KpDpKKOSend3rdBatch {

    private static final String BATCH_JOB_NAME = "kpDpKKOSend3rdJob";
    ...
    public Tasklet execTasklet() {
        return (contribution, chunkContext) -> {
            ...
            try {
                ...
                kpDpKKOSendBatchService.inspectAutoSms3th(batchParam, batchLogDto);
            } catch (Exception e) {
