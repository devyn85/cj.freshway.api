 ...
 * @date : 2025.08.29 
 * @description : 피킹작업지시-조회생성 목록 결과 DTO
 * @issues :<pre> 
 * ----------------------------------------------------------- 
 ...
 */
@Data
@Schema(description = "피킹작업지시-조회생성 목록 결과")
public class WdTaskResTab1Dto extends CommonDto{
	/** 커스텀 엑스트라 체크박스 */
    ...
    /**
     * 차량번호(WdTaskResTab4Dto) 피킹생성 처리용
     */
    @Schema(description = "차량번호", example = "P001")
