 ...
 * @date        : 2025.07.17
 * @description : 운송사정보 조회(단건) 요청 DTO
 * @issues      :
 * -----------------------------------------------------------
 * DATE              AUTHOR             MAJOR_ISSUE
 * -----------------------------------------------------------
 * 2025.07.18        YeoSeungCheol (pw6375@cj.net)       생성
 */
@Data
@Builder
@NoArgsConstructor
...
@Schema(description = "운송사정보 조회(단건) 요청 DTO")
public class MsCarrierDetailReqDto extends CommonDto{
    @Schema(description = "데이터번호")
    private String serialKey; // 수정 시 사용
