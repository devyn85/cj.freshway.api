 ...
 * @date : 2025.08.25
 * @description : 상품이력번호등록 Request DTO Class
 * @issues :
 *         <pre>
 * -----------------------------------------------------------
 ...
 *         </pre>
 */
@Schema(description = "상품이력번호등록 Request DTO")
@Data
public class StSkuLabelReqDto extends CommonProcedureDto {
	...
	/** 지정취소 저장 리스트 */
	List<StSkuLabelResDto> saveList;
	
	List<StSkuLabelResDto> excelUploadList;
