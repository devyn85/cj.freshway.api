...
public class MsCenterDocEmailSendBatch {

    private static final String BATCH_JOB_NAME = "msCenterDocEmailSendJob";
	...
	@Bean
	public Job msCenterDocEmailSendJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("msCenterDocEmailSendService.callProcExecute", batchParam);
			} catch (Exception e) {
