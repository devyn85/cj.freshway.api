...
@Schema(description = "GPS협력사정보 요청 DTO")
public class MsCustDeliveryInfoPReqDto extends CommonProcedureDto {
    ...
    /** 이전정보 */
	@Schema(description = "이전정보", example = "")
	private MsCustDeliveryInfoPMasterResDto beforeData;
