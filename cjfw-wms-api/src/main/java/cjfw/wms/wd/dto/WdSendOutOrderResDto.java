 ...
 * @date : 2025.06.10 
 * @description : 외부비축출고지시 조회 결과 DTO
 * @issues :<pre> 
 * ----------------------------------------------------------- 
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "외부비축출고지시 조회 결과") 
public class WdSendOutOrderResDto extends CommonProcedureDto {
    ...
    /** 채널 */
    @Schema(description = "채널", nullable = false, example = "")
    ...
    /** 전표유형 */
    @Schema(description = "전표유형", nullable = false, example = "")
    ...
    /** 등록자명 */
    @Schema(description = "등록자명", nullable = false, example = "")
    ...
    private String emailTrSenduser;
    
    /** 이메일 발송자 이름 */
    @Schema(description = "이메일 발송자 이름", nullable = false, example = "")
    ...
    /** 팩스 성공 전송자 */
    @Schema(description = "팩스 성공 전송자", nullable = false, example = "")
    private String faxSuccTrSenduser;
    ...
    /** 팩스 실패 전송자 */
    @Schema(description = "팩스 실패 전송자", nullable = false, example = "")
    private String faxFailTrSenduser;
    ...
    /** 발송요청자명 */
    @Schema(description = "발송요청자명", nullable = false, example = "")
    private String docnoconfirmNm;
    ...
    /** 주문 단위 */
    @Schema(description = "주문 단위", nullable = false, example = "")
    ...
    /** 문서이름 */
    @Schema(description = "문서이름", nullable = true, example = "")
    private String docName;
    
    /** 수기출고사유명 */
    @Schema(description = "수기출고사유명", nullable = true, example = "")
