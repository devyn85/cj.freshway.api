...
public class MsPlantxslBatch  {

    private static final String BATCH_JOB_NAME = "msPlantxslJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("msPlantxslService.callProcExecute", batchParam);
			} catch (Exception e) {
