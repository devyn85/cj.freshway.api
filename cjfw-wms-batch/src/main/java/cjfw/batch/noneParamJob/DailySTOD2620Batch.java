...
public class DailySTOD2620Batch {

	private static final String BATCH_JOB_NAME = "dailySTOD2620Job";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTOD2620", batchParam);
			} catch (Exception e) {
