...
public class DailySTOD2230Batch {

	private static final String BATCH_JOB_NAME = "dailySTOD2230Job";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTOD2230", batchParam);
			} catch (Exception e) {
