...
public class TmdeliverytimeBatch {

	private static final String BATCH_JOB_NAME = "tmdeliverytimeJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "tmDeliverytime", batchParam);
			} catch (Exception e) {
