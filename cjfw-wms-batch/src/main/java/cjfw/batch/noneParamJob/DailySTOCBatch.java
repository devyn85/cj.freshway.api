...
public class DailySTOCBatch {

	private static final String BATCH_JOB_NAME = "dailySTOCJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTOC", batchParam);
			} catch (Exception e) {
