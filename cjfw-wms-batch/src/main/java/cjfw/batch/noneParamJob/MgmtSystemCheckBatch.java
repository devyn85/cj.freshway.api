...
public class MgmtSystemCheckBatch {

	private static final String BATCH_JOB_NAME = "mgmtSystemCheckJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "mgmtSystemCheckJobs", batchParam);
			} catch (Exception e) {
