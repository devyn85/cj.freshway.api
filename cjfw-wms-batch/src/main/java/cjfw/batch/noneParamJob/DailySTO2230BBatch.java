...
public class DailySTO2230BBatch {

	private static final String BATCH_JOB_NAME = "dailySTO2230BJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailySTO2230B", batchParam);
			} catch (Exception e) {
