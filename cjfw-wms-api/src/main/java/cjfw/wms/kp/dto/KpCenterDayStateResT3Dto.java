 ...
 * @date : 2025.09.03
 * @description : 지표 > 센터 운영 > 출고 유형별 물동 현황 배송차량_탭 Response DTO Class
 * @issues :
 *
 *         <pre>
 * -----------------------------------------------------------
 ...
 *         </pre>
 */
@Schema(description = "지표 > 센터 운영 > 출고 유형별 물동 현황 배송차량_탭 Response DTO")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class KpCenterDayStateResT3Dto extends CommonProcedureDto {
	...
	/* 03. 차량종류 */
	@Schema(description = "03. 차량종류")
	private String course;

	/* 04. 차량종류 * */
	@Schema(description = "04. 차량종류 *")
	private String coursenm;

	/* 05. 차량톤수 */
	@Schema(description = "05. 차량톤수")
	private String capacity;

	/* 06. 차량톤수 * */
	@Schema(description = "06. 차량톤수 *")
	private String capacitynm;
