 ...
 * @date : 2025.08.19 
 * @description : 자동분배-피킹존별 상세 결과 DTO
 * @issues :<pre> 
 * ----------------------------------------------------------- 
 ...
 */
@Data
@Schema(description = "자동분배-피킹존별 상세 결과")
public class WdAllocationBatchGroupResTab1ZoneDto extends CommonDto{
	/** 커스텀 엑스트라 체크박스 */
	@Schema(description = "커스텀 엑스트라 체크박스", example = "N")
	private String customRowCheckYn = "N";
	
	@Schema(description = "피킹존", example = "H01")
    private String zone;
