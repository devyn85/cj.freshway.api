...
public class ReProcessKxBatch {

    private static final String BATCH_JOB_NAME = "reProcessKxJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("reProcessKxService.callProcExecute", batchParam);
			} catch (Exception e) {
