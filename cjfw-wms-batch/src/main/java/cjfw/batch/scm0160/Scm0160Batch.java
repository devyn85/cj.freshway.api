...
public class Scm0160Batch {

	private static final String BATCH_JOB_NAME = "scm0160Job";
	private final CommonDao commonDao;

	private final Scm0160BatchService scm0160BatchService;
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				scm0160BatchService.callScm0160JobService(batchParam, batchLogDto); 
