 ...
 * @date : 2025.09.04
 * @description : 외부창고 API 재고현황 조회 결과 DTO 
 * @issues : 
 * ----------------------------------------------------------- 
 ...
 */
@Data
@Schema(description = "외부창고 API 재고현황 인터페이스 조회 결과")
public class StDailyOnhandQtyAPIIFResDto extends CommonDto {
	/** 커스텀 엑스트라 체크박스 */
    ...
    /** WMS 현재고 */
    @Schema(description = "WMS 현재고", nullable = true, example = "")
    private BigDecimal wmsCurrStock;
    ...
    /** 소비기한제조일자 */
    @Schema(description = "소비기한제조일자", nullable = true, example = "")
