...
public class DailyTCSPURCHASESTATSBatch {

	private static final String BATCH_JOB_NAME = "dailyTCSPURCHASESTATSJob";
	...
	@Bean
	public Job dailyTCSPURCHASESTATSJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailyTCSPURCHASESTATS", batchParam);
			} catch (Exception e) {
