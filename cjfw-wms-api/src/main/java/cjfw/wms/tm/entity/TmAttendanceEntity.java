 ...
 * @author : ParkJinWoo 
 * @date :  2025.09.16 
 * @description : 근태관리 Entity 기능을 구현한 Entity Class 
 * @issues : 
 * ----------------------------------------------------------- 
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "근태관리 Entity") 
public class TmAttendanceEntity extends CommonDto {
	/** 기본센터코드 */
