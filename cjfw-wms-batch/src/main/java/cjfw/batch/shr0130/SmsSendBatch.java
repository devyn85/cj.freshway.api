...
public class SmsSendBatch {
	...
	private static final String BATCH_JOB_NAME = "smsSendJob";
	private final CommonDao commonDao;

	private final SmsSendBatchService smsSendBatchService;
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
            ...
            try {
				...
				smsSendBatchService.callSmsSendJobService(batchParam, batchLogDto); 
