...
public class StEmailSendBatch {

    private static final String BATCH_JOB_NAME = "stEmailSendJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("stEmailSendService.processRefSOderReceive", batchParam);
			} catch (Exception e) {
