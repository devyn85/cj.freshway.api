...
public class DailykxpoBatch {

	private static final String BATCH_JOB_NAME = "dailykxpoJob";
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailykxpo", batchParam);
			} catch (Exception e) {
