 ...
 * @date : 2025.09.04 
 * @description : 외부창고 API 재고현황 인터페이스 저장 Entity
 * @issues : 
 * ----------------------------------------------------------- 
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "외부창고 API 재고현황 인터페이스 저장 Entity") 
public class StDailyOnhandQtyAPIIFEntity extends CommonDto {
    ...
    /** 사용자ID */
    @Schema(description = "사용자ID", nullable = true, example = "")
    private String userId;
    
    /** 인터페이스ID */
    @Schema(description = "인터페이스ID", nullable = true, example = "")
    private String ifId;
