 ...
 * @date : 2025.09.03
 * @description : 지표 > 센터 운영 > 출고 유형별 물동 현황 배송물동_탭 Response DTO Class
 * @issues :
 *
 *         <pre>
 * -----------------------------------------------------------
 ...
 *         </pre>
 */
@Schema(description = "지표 > 센터 운영 > 출고 유형별 물동 현황 배송물동_탭 Response DTO")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class KpCenterDayStateResT1Dto extends CommonProcedureDto {
