...
/**
 * <p>DT_SCM0330_SCM_response complex type�� ���� Java Ŭ�����Դϴ�.</p>
 * 
 * <p>���� ��Ű�� ������ �� Ŭ������ ���ԵǴ� �ʿ��� �������� �����մϴ�.</p>
 * 
 * <pre>{@code
 * <complexType name="DT_SCM0330_SCM_response">
 *   <complexContent>
...
@XmlType(name = "DT_SCM0330_SCM_response", propOrder = {
    "treturn"
})
public class DTSCM0330SCMResponse {
