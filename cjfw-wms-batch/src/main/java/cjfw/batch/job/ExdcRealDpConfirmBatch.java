...
public class ExdcRealDpConfirmBatch {

	private static final String BATCH_JOB_NAME = "exdcRealDpConfirmJob";
	...
	@Bean
	public Job exdcRealDpConfirmJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne("exdcRealDpConfirmService.callProcExecute", batchParam);
			} catch (Exception e) {
