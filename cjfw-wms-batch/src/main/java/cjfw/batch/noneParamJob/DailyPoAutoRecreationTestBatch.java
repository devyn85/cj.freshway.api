...
public class DailyPoAutoRecreationTestBatch {

	private static final String BATCH_JOB_NAME = "dailyPoAutoRecreationTestJob";
	private final CommonDao commonDao;

	private static final String SERVICEID_PREFIX = "noneParamJob.";
	...
	@Bean
	public Job dailyPoAutoRecreationTestJob() {
	...
	public Tasklet execTasklet() {
		return (contribution, chunkContext) -> {
			...
			try {
				...
				commonDao.selectOne(SERVICEID_PREFIX + "dailyPoAutoRecreationTest", batchParam);
			} catch (Exception e) {
